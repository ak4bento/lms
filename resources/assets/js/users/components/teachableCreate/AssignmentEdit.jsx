  ...
  componentDidMount() {
    ...
    this.props.teachable ?
      this.setState({
        ...
        availableAt: this.props.teachable.availableAt ? this.props.teachable.availableAt : null,
        expiresAt: this.props.teachable.expiresAt ? this.props.teachable.expiresAt : null
      }) : ''
  ...
  save() {
    ...
    return this.api.update({
      ...
      data: {
        ...
        availableAt: this.state.availableAt ? this.state.availableAt.format("YYYY-MM-DD hh:mm:ss") : null,
        expiresAt: this.state.expiresAt ? this.state.expiresAt.format("YYYY-MM-DD hh:mm:ss") : null,
