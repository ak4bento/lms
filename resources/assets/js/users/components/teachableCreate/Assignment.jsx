  ...
  save() {
    ...
    return this.api.store({
      data: {
        ...
        availableAt: this.state.data.availableAt ? this.state.data.availableAt.format('YYYY-MM-DD HH:mm:ss') : null,
        expiresAt: this.state.data.expiresAt.format('YYYY-MM-DD HH:mm:ss'),
      },
